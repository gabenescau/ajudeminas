...
export default function App() {
  ...
  const gerarPix = async (val: number) => {
    ...
    try {
      console.log("Gerando PIX via ZuckPay (Direto Front-end)...");
      
      // Credenciais fornecidas pelo usuário
      const clientId = "nobrerich_2200294314";
      const clientSecret = "3ff4b1ffe2813ef88e3435f66720ba1c24041eba4b0bb2e09a560732b27c226b";

      if (!clientId || !clientSecret) {
        throw new Error("Credenciais ZuckPay não configuradas.");
      }

      const auth = btoa(`${clientId}:${clientSecret}`);

      // Usando o proxy configurado (Vite/Netlify/Vercel) para evitar erro de CORS
      const response = await fetch("/api/proxy/zuckpay/qrcode", {
        method: 'POST',
        headers: { 
            ...
            <div className="col-md-4">
              <div className="card-campanha" onClick={() => carregarCampanha('AJUDA HUMANITÁRIA INDEP...', '3049123', 3793946.09, 5000000, 'https://i.imgur.com/4TjmssB.png')}>
                ...
                <div className="card-body-campanha">
                  ...
                  <div className="btn-sm-green text-center" style={{cursor: 'pointer', display: 'inline-block'}}>CONTRIBUIR</div>
                </div>
              </div>
            </div>
            <div className="col-md-4">
        ...
        <div id="modal-doacao" className="modal-custom-backdrop">
          <div className="modal-custom-content">
            ...
            <div className="checkout-body">
              ...
              <div className="btn-finalizar" onClick={processarDoacao} style={{cursor: 'pointer'}}>
        ...
        <div id="modal-pix" className="modal-custom-backdrop">
          <div className="modal-custom-content text-center">
            <div className="checkout-header border-0 pb-0">
               <div className="close-custom" onClick={fecharModal} style={{cursor: 'pointer'}}>×</div>
            ...
            <div className="p-4 pt-0">
              ...
              <div className="input-group mb-3">
                ...
                <div className="btn btn-outline-success fw-bold d-flex align-items-center" onClick={copiarPixCode} style={{cursor: 'pointer'}}><i className="bi bi-clipboard me-1"></i> Copiar</div>
              </div>
